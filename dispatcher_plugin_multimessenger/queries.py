...
class MMDataDispatcher:
    def __init__(self, param_dict) -> None:
        pars = param_dict['anal_par_csv'].value.split(';')
        self.products_api_params = [self.get_params_from_string(x) for x in pars]
    ...
    @staticmethod
    def get_params_from_string(pars):
        query_dict = json.loads(pars)
